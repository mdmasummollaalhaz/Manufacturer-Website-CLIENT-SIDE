...
import footerbg from '../../assets/images/fooerbg.jpeg'

const Footer = () => {
    return (
        <footer style={{ backgroundImage: `url(${footerbg})`, backgroundRepeat: 'no-repeat', backgroundSize: 'cover' }}>
            <div className="container mx-auto ">
                <div className="footer p-10 text-indigo-50 grid grid-flow-row grid-cols-3">
                    <div>
                    ...
                    <div>
                        <span className="footer-title text-slate-50 opacity-100 ">Company</span>
                    ...
                    <div>
                        <span className="footer-title text-white opacity-100">Social</span>
